...
//   Writes the results to ~/Documents/patches.txt
//
...
public class ghidra_get_patchpoints extends GhidraScript {
	...
	public void run() throws Exception {
		...
		BufferedWriter out = new BufferedWriter(new FileWriter(System.getProperty("user.home") + File.separator + "Documents" + File.separator + "patches.txt"));
